...
class Dust3R(CroCoNet):
    ...
    @torch.no_grad()
    def forward(
        self, context: dict, symmetrize_batch=False, return_views=False, normalize=False
    ):
        ...
        if symmetrize_batch:
            ...
            (shape1, shape2), (feat1, feat2), (pos1, pos2) = self._encode_symmetrized(
                view1, view2, force_asym=False
            )
        else:
            # encode the two images --> B,S,D
            (shape1, shape2), (feat1, feat2), (pos1, pos2) = self._encode_symmetrized(
                view1, view2, force_asym=True
            )
    ...
    def estimate_pose(self, context, normalize=False):
        ...
        res1, res2, view1, view2 = self.forward(
            context, symmetrize_batch=True, return_views=True
        )
        ...
        for i in range(b):
            ...
            result = dict(
                view1=view1_tmp, view2=view2_tmp, pred1=pred1_tmp, pred2=pred2_tmp
            )
