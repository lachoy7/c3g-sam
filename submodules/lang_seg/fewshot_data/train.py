...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--benchmark", type=str, default="pascal", choices=["pascal", "coco", "fss"]
    )
    ...
    FSSDataset.initialize(
        img_size=400, datapath=args.datapath, use_original_imgsize=False
    )
    ...
    for epoch in range(args.niter):
        ...
        Logger.tbd_writer.add_scalars(
            ...
            {"trn_miou": trn_miou, "val_miou": val_miou},
            epoch,
        )
        Logger.tbd_writer.add_scalars(
            "fewshot_data/data/fb_iou",
            {"trn_fb_iou": trn_fb_iou, "val_fb_iou": val_fb_iou},
            epoch,
        )
